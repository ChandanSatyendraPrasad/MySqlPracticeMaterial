...
• Author should have the following properties: first name, last name, email, phone, website, date
created, date updated.
• Book should have the following properties: title, subtitle, description, ISBN, price, date created,
date updated.
